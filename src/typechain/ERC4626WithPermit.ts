...
export interface ERC4626WithPermitInterface extends utils.Interface {
  functions: {
...
export interface ERC4626WithPermit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC4626WithPermitInterface;
