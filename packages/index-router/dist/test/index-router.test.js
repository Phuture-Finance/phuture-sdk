...
// 					.setup(async (c) =>
// 						c.checkAllowance(router.address, amountInInputToken)
// 					)
// 					.returnsAsync(true)
// 					.object();
//
...
// 				const indexAddress = DefaultIndexRouterAddress.Mainnet
...
// 			const contract = new Mock<IndexRouterContractInterface>()
// 				.setup((c) => c.address)
// 				.returns(DefaultIndexRouterAddress.Mainnet);// import {Erc20, Erc20Permit, StandardPermitArguments} from "@phuture/erc-20";
// // import {InsufficientAllowanceError} from "@phuture/errors";
// // import {expect} from "chai";
// // import {BigNumber, constants} from "ethers";
// // import {ContractTransaction} from "ethers/lib/ethers";
...
// 	});
// });
//# sourceMappingURL=index-router.test.js.map