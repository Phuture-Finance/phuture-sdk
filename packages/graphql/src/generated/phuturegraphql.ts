...
export type Index = {
	...
	hourlyStats: HourlyIndexStat[];
	/** Address (hash) */
	id: Scalars['ID'];
	inactiveAssets?: Maybe<IndexAsset[]>;
	indexFactory: IndexFactory;
	marketCap: Scalars['BigDecimal'];
	monthlyStats: MonthlyIndexStat[];
	name: Scalars['String'];
	...
	uniqueHolders: Scalars['BigInt'];
	users: UserIndex[];
	weeklyStats: WeeklyIndexStat[];
	yearlyStats: YearlyIndexStat[];
};
...
export type Query = {
	...
	userCapitalizations: UserCapitalization[];
	userIndex?: Maybe<UserIndex>;
	userIndexHistories: UserIndexHistory[];
	...
	weeklyIndexStats: WeeklyIndexStat[];
	yearlyIndexStat?: Maybe<YearlyIndexStat>;
	yearlyIndexStats: YearlyIndexStat[];
};
...
export type Transfer_Filter = {
	...
	type_in?: InputMaybe<TransferType[]>;
	type_not?: InputMaybe<TransferType>;
	type_not_in?: InputMaybe<TransferType[]>;
	value?: InputMaybe<Scalars['BigInt']>;
	value_gt?: InputMaybe<Scalars['BigInt']>;
	value_gte?: InputMaybe<Scalars['BigInt']>;
	value_in?: InputMaybe<Array<Scalars['BigInt']>>;
...
export type GetCapitalizationsQuery = {
	__typename?: 'Query';
	dailyCapitalizations: Array<{
		__typename?: 'DailyCapitalization';
		id: string;
		capitalization: any;
		timestamp: any;
		logIndex: any;
		index: {__typename?: 'Index'; id: string; symbol: string};
	}>;
};
...
export type GetUserIndicesQuery = {
	__typename?: 'Query';
	users: Array<{
		__typename?: 'User';
		indexes: Array<{
			__typename?: 'UserIndex';
			index: {__typename?: 'Index'; id: string; symbol: string; name: string};
		}>;
	}>;
};
...
export type GetUserIndexHistoriesQuery = {
	__typename?: 'Query';
	userIndexHistories: Array<{
		__typename?: 'UserIndexHistory';
		balance: any;
		capitalization: any;
		totalSupply: any;
...
export const GetUserIndexHistoriesDocument = gql`
	query getUserIndexHistories($id: String!, $dateLimit: BigInt!) {
		userIndexHistories(
			where: {user: $id, timestamp_gte: $dateLimit}
			orderBy: id
		) {
			index {
				id
...
export function getSdk(
	...
	return {
		async getCapitalizations(
			variables: GetCapitalizationsQueryVariables,
			requestHeaders?: Dom.RequestInit['headers'],
		): Promise<GetCapitalizationsQuery> {
			return withWrapper(
				async (wrappedRequestHeaders) =>
					client.request<GetCapitalizationsQuery>(
						GetCapitalizationsDocument,
						variables,
		...
		async getUserIndices(
			variables: GetUserIndicesQueryVariables,
			requestHeaders?: Dom.RequestInit['headers'],
		): Promise<GetUserIndicesQuery> {
			return withWrapper(
				async (wrappedRequestHeaders) =>
					client.request<GetUserIndicesQuery>(
						GetUserIndicesDocument,
						variables,
						{...requestHeaders, ...wrappedRequestHeaders},
					),
				'getUserIndices',
		...
		async getUserIndexHistories(
			variables: GetUserIndexHistoriesQueryVariables,
			requestHeaders?: Dom.RequestInit['headers'],
		): Promise<GetUserIndexHistoriesQuery> {
			return withWrapper(
				async (wrappedRequestHeaders) =>
					client.request<GetUserIndexHistoriesQuery>(
						GetUserIndexHistoriesDocument,
						variables,
						{...requestHeaders, ...wrappedRequestHeaders},
					),
				'getUserIndexHistories',
				'query',
			);
		},
	};
