...
export type GetRangesByAddressQueryVariables = Exact<{
  address: Scalars['String'];
}>;


export type GetRangesByAddressQuery = { __typename?: 'Query', vestingRanges: Array<{ __typename?: 'VestingRange', id: string, account: string, amount: any, rangeStartIndex: any, rangeEndIndex: any }> };

export type GetReservesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetReservesQuery = { __typename?: 'Query', reserves: Array<{ __typename?: 'Reserve', id: string, token0: string, token1: string, totalSupply: any, reserve0: any, reserve1: any, token0Decimals: any, token1Decimals: any }> };


export const GetRangesByAddressDocument = gql`
    query getRangesByAddress($address: String!) {
  vestingRanges(where: {unstaked: false, account: $address}) {
    id
    account
    amount
    rangeStartIndex
    ...
    `;
export const GetReservesDocument = gql`
    query getReserves {
  reserves {
    id
    token0
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getRangesByAddress(variables: GetRangesByAddressQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetRangesByAddressQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRangesByAddressQuery>(GetRangesByAddressDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getRangesByAddress', 'query');
    },
    getReserves(variables?: GetReservesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetReservesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetReservesQuery>(GetReservesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getReserves', 'query');
    }
  };
}
